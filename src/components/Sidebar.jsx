    ...
    <>
      ...
      >
        <div className="mb-6 px-2">
          <h2 className="bg-gradient-to-r from-indigo-200 via-cyan-200 to-purple-200 bg-clip-text text-sm font-semibold uppercase tracking-[0.2em] text-transparent">Navigation</h2>
        </div>
